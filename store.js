...
(function () {
  ...
  var PRODUCTS = [
    ...
    },
    {
      ...
      gallery: ['assets/facewash.png', 'assets/facewash-2.png', 'assets/facewash-3.png', 'assets/facewash-4.png'],
    ...
    },
    {
      ...
      gallery: ['assets/sunscreen.png', 'assets/sunscreen-2.png', 'assets/sunscreen-3.png', 'assets/sunscreen-4.png'],
      badge: 'Bestseller',
    ...
    },
    {
      ...
      gallery: ['assets/bundle-cream-facewash.png', 'assets/bundle-cream-facewash-2.png', 'assets/cream.png', 'assets/facewash.png'],
    ...
    },
    {
      ...
      name: 'Tinted Sunscreen + Face Wash',
      sub: 'Special Offer 2 · Cleanse & protect',
      size: 'Face Wash 150ml + Sunscreen 50ml',
      price: 2299,
      compareAt: 2498,
      bundle: true,
      img: 'assets/bundle-sun-facewash.png',
      gallery: ['assets/bundle-sun-facewash.png', 'assets/bundle-sun-facewash-2.png', 'assets/sunscreen.png', 'assets/facewash.png'],
      badge: 'Special Offer 2',
      short: 'The morning pair — a Vitamin C cleanse, then SPF 50+ tinted protection.',
      description: 'Special Offer 2 pairs the Brightening Face Wash with Tinted Sunscreen SPF 50+. Cleanse, then shield against UVA, UVB, pollution and blue light with a weightless tint that evens tone. Together they save Rs 199.',
      benefits: ['A complete morning routine', 'Broad-spectrum SPF 50+', 'Evens tone, no white cast', 'Saves Rs 199'],
      howto: [
        ['Cleanse', 'Massage the gel-bead face wash into damp skin, then rinse.'],
        ['Protect', 'A generous even layer of Tinted Sunscreen, 15 minutes before you leave.'],
    ...
    },
    {
      ...
      size: 'Face Wash 150ml + Sunscreen 50ml + Night Cream 50g',
      price: 3799,
      compareAt: 3997,
      bundle: true,
      img: 'assets/trio.png',
      gallery: ['assets/trio.png', 'assets/trio-2.png', 'assets/cream.png', 'assets/sunscreen.png', 'assets/facewash.png'],
      badge: 'Best value',
      short: 'The complete routine: brightening cleanse, SPF 50+ by day, renewal by night.',
      description: 'All three formulas together. Cleanse with the Vitamin C gel-bead face wash, shield through the day with Tinted Sunscreen SPF 50+, and let the Anti Aging Night Cream rebuild firmness overnight. The full routine, with free delivery.',
      benefits: ['A complete AM + PM routine', 'Brightens and evens tone', 'Daily broad-spectrum defence', 'Overnight firming and repair'],
      howto: [
        ['Morning', 'Face Wash, then Tinted Sunscreen SPF 50+.'],

  ...
  var PRODUCTS = [
    {
      ...
      size: '50g / 1.76oz',
      price: 1500,
      img: 'assets/cream-beach.png',
      gallery: ['assets/cream-beach.png', 'assets/trio.png'],
    ...
    },
    {
      ...
      price: 1050,
      img: 'assets/facewash-beach.png',
      gallery: ['assets/facewash-beach.png', 'assets/trio.png'],
    ...
    },
    {
      ...
      price: 1250,
      img: 'assets/sunscreen-marble.jpg',
      gallery: ['assets/sunscreen-marble.jpg', 'assets/sunscreen-box.jpg', 'assets/sunscreen-beach.jpg'],
      badge: 'Bestseller',
    ...
    {
      sku: 'IB-SET-3',
      slug: 'the-iconix-ritual',
      name: 'The Iconix Ritual',
      sub: 'All three · Cleanse, protect, renew',
      size: 'Facewash 150ml + Sunscreen 50ml + Night Cream 50g',
      price: 3500,
      compareAt: 3800,
      img: 'assets/trio.png',
      gallery: ['assets/trio.png', 'assets/cream-beach.png', 'assets/sunscreen-box.jpg'],
      badge: 'Save Rs 300',
      short: 'The complete routine: brightening cleanse by day, SPF 50+ protection, overnight renewal.',
      description: 'The full Iconix routine in one box. Cleanse with the Vitamin C gel-bead facewash, shield through the day with Tinted Sunscreen SPF 50+, and let the Anti Aging Night Cream rebuild firmness overnight. Bought together, the set saves Rs 300.',
      benefits: ['A complete AM + PM routine', 'Brightens and evens tone', 'Daily broad-spectrum defence', 'Overnight firming and repair'],
      howto: [
        ['Morning', 'Facewash, then Tinted Sunscreen SPF 50+.'],
        ['Evening', 'Facewash, then Anti Aging Night Cream.'],
